...
legend('Nueral network forecasted load', 'Actual load');
title('One day ahead short term load prediction using Neural Networks','Fontsize', 12,'color','b');   ylabel('Load in Kw');   xlabel('Time in Hour'); 
